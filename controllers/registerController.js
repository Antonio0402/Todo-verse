...
var registerController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user_email, password, user, hash, register_result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (user.rows.length) {
                    return [2 /*return*/, res.status(409).json({ message: "User with ".concat(user_email, " already exists!") })];
                }
                _b.label = 2;
            case 2:
                _b.trys.push([2, 4, , 5]);
                hash = (0, utils_js_1.bCryptGenPass)(password);
                return [4 /*yield*/, (0, todos_database_js_1.query)("INSERT INTO public.users(user_email, hashed_password) VALUES($1, $2) RETURNING *;", [user_email, hash])];
            case 3:
                register_result = _b.sent();
                if (register_result.rows.length) {
                    res.status(201).json("New user ".concat(user_email, " has been created successfully!"));
                }
                else {
